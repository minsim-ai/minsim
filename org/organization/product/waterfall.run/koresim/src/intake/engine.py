"""LangGraph-ready backend intake planner.

This keeps the first backend endpoint deterministic while matching the product
contract used by the React planner: user input is converted into task frame,
slots, next action, and a safe summary that can be attached to a run.
"""

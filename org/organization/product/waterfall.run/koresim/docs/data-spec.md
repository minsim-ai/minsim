...
title: 데이터 명세서 — Nemotron-Personas-Korea  
type: data-spec  
tags: \[data, schema, nemotron\]  
created: 2026-04-30  
updated: 2026-04-30  
status: stable  
related: \[\[prd\]\], \[\[functional/overview\]\]

---

# 데이터 명세서 — Nemotron-Personas-Korea
...
*   **기본 로컬 경로**: `data/nemotron_korea_personas.parquet` (`PARQUET_PATH`로 override 가능)

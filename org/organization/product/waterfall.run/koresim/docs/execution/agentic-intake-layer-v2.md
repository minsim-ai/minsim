...
- [x] backend `/api/intake/advance`를 추가해 frontend planner를 점진적으로 이전할 수 있게 한다.
...
- [x] deterministic backend intake advance endpoint 추가.
- [x] 9 simulations x 8 categories fixture coverage 추가.

### Out of scope

- [x] frontend planner를 즉시 backend planner로 완전 교체.

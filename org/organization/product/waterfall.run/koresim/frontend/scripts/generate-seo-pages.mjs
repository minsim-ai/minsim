...
<html lang="ko">
  <head>
    ...
    <style>
      body{margin:0;background:#08090a;color:#f8fafc;font-family:Pretendard,system-ui,sans-serif;line-height:1.7}
      main{max-width:1040px;margin:0 auto;padding:72px 24px}a{color:#e4f222}.eyebrow{color:#e4f222;font-weight:800;font-size:13px;text-transform:uppercase}
      h1{font-size:clamp(38px,6vw,68px);line-height:1.08;margin:16px 0 24px;letter-spacing:-.02em}h2{font-size:28px;margin:56px 0 16px}p,li,td,th{color:#cbd5e1;font-size:17px}
      .grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:16px;margin-top:28px}.card{border:1px solid rgba(255,255,255,.14);border-radius:12px;padding:20px;background:#111418}
      .cta{display:inline-block;margin-top:28px;padding:13px 20px;border-radius:999px;background:#e4f222;color:#08090a;font-weight:900;text-decoration:none}
      ...
      table{width:100%;border-collapse:collapse;margin-top:24px;background:#111418;border:1px solid rgba(255,255,255,.14);border-radius:12px;overflow:hidden}th,td{text-align:left;border-bottom:1px solid rgba(255,255,255,.1);padding:14px}

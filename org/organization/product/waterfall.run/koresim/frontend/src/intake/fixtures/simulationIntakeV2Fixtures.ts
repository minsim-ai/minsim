    ...
    return [
      {
        ...
        category: "goal_only",
        events: [{ type: "user_message", content: spec.goal }],
        expectedAction: typedSimulation === "creative_testing" ? "show_form" : "ask_question",
      ...
      },
      {
        ...
        category: "partial",
        events: [
          { type: "user_message", content: spec.goal },
      ...
      },
      {
        ...
        category: "ambiguous",
        events: [{ type: "user_message", content: spec.ambiguousGoal }],
        expectedAction: typedSimulation === "value_proposition" ? "show_form" : "ask_question",
      },
      {
        id: `${simulationType}-messy-v2`,
        title: `${simulationType} messy natural language does not run blindly`,
        category: "messy",
        events: [{ type: "user_message", content: spec.messyGoal }],
      ...
      },
      {
        ...
        events: [{ type: "user_message", content: `${spec.goal} 나머지는 알아서 해주세요.` }],
        expectedAction: typedSimulation === "creative_testing" ? "show_form" : "ask_question",
        expectedSimulationType: typedSimulation,
      },
      {

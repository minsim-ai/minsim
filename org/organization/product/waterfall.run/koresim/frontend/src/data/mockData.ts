...
export const chatSteps: Record<string, ChatStep[]> = {
  ...
  value_proposition: [
    ...
    { id: "sample_size", type: "radio", question: "샘플 크기는?", options: ["100명", "200명 (표준)", "500명"] },
  ],
  market_segmentation: [
    ...
    { id: "sample_size", type: "radio", question: "샘플 크기는?", options: ["300명", "500명 (표준)", "1000명"] },
  ],
  competitive_positioning: [
    ...
    { id: "sample_size", type: "radio", question: "샘플 크기는?", options: ["200명", "300명 (표준)", "500명"] },
  ],
  brand_perception: [
